...
function evenFn(maxValue) {
    var result = [];
    for (let i=2; i<=maxValue; i=i+2){
        result.push(i);
    }
    return result;
}
 ...
 * #6
 *
 * створіть функцію ageClassification(n), яка буде як параметр приймати будь-які числа і 
 * повертатиме рядок згідно з такими умовами, n:
